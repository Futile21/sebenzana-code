...
export const SharedData = {
  Area : {
    ...
    heading:'ESV’s To the Control Valves',
    text:'The Pressure at the A-point is (link) and the Pressure at the B-point is (link). At X is Low (red) At Y is high (red)  Between the ESV’s and the Control Valves (CV’s, sometimes called Governing Valves)',
  },
  Concentricity : {
